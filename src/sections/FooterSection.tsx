  ...
  return (
    <footer className="footer">
      <div className="section-container">
        ...
        >
          <div>
            <div className="footer__logo">DR. OTHÓN BOUTIQUE DENTAL</div>
          ...
          <div className="footer__social">
            <a href="https://instagram.com/drothon_boutiquedental" className="footer__social-link interactive" aria-label="Instagram">
